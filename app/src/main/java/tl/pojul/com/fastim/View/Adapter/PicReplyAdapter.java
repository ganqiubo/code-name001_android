...
public class PicReplyAdapter extends RecyclerView.Adapter<PicReplyAdapter.BaseViewHolder> {
    ...
    public PicReplyAdapter(Context mContext, List<ReplyMessage> mList, User user, TagCommuMessage tagCommuMessage) {
