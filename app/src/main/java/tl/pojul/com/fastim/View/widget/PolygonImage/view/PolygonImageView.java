...
package tl.pojul.com.fastim.View.widget.PolygonImage.view;
...
import tl.pojul.com.fastim.View.widget.PolygonImage.shapes.PolygonShape;
import tl.pojul.com.fastim.View.widget.PolygonImage.shapes.PolygonShapeSpec;
import tl.pojul.com.fastim.View.widget.PolygonImage.shapes.RegularPolygonShape;
            ...
            case 0: //CIRCLE
                if (mPolygonShapeSpec.hasShadow() || mPolygonShapeSpec.hasBorder()) {
                    canvas.drawCircle(mPolygonShapeSpec.getCenterX(),mPolygonShapeSpec.getCenterY(),
                            mPolygonShapeSpec.getDiameter()*1.0f / 2, mBorderPaint);
                }
                canvas.drawCircle(mPolygonShapeSpec.getCenterX(), mPolygonShapeSpec.getCenterY(),
                        mPolygonShapeSpec.getDiameter()*1.0f / 2, mPaint);
                break;
